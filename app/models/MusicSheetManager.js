function MusicSheetManager(challangeId, xToSing)
{
    ...
    this.loadChallange = function()
    {
        ...
        let lastElement = jsonSheet.sheet[jsonSheet.sheet.length - 1];
        let challangeDuration = lastElement[SHEET_INDEX_END];

        this.name = jsonSheet.name;
        this.type = jsonSheet.type;
        this.sheet = jsonSheet.sheet;
        this.challangeDuration = challangeDuration;
    };
    ...
    this.type = null;
    this.sheet = null;
    this.challangeDuration = null;
    this.challange = this.loadChallange(challangeId);
